...
13. Right-click the **birthdate** column, go to **Change type**, and then select **Date**.

     ![](./media/image14.png)

14. Select the following columns by holding down the **Ctrl** key on your keyboard: **annualincome**, **msrc_creditscore**, **msrc_customerrelationshipduration**,
...
16. Under **Properties** on the right side, change the **Name** to +++**contact**+++ and then press the **Enter** key on your keyboard.
...
29. Scroll to and select the **msrc_transactiontimestamp** column. Right-click the column, select **Change type**, and then
    select **Date/Time**.
...
4.  Enter a description of your segment or choose one of the suggested
     ...
     **Note**: If Copilot gives a message that ‘Sorry, I’m having trouble
     ...
     to **Step 6**, enter the rule as shown in the image of Step 5, and  select **Run**.
