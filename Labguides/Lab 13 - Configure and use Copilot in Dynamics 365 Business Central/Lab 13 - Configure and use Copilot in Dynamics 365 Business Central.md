...
1.  Go to +++**https://dynamics.microsoft.com/en-us/dynamics-365-free-trial/**+++, on
    the **Dynamics 365 Business Central** card, choose the **Try for free** button.
...
6.  Enter **Country or region** – **United States**, **Job title** – enter your job title, enter your phone number and then select **Get Started**.
...
2.  To get a new suggestion, select **Regenerate**.
     ...
     **Note**: If you're not satisfied with the suggestions, enhance the text suggestions using the Tone, Format, and Emphasis preference options.
...
1.  Select the search icon that opens the Tell Me feature icon, enter +++**Bank Account Reconciliations**+++, and then choose the related link.
...
3.  In the **Bank Acc. Reconciliation** card: click the drop-down menu next to the Copilot icon, then select **Reconcile**.
