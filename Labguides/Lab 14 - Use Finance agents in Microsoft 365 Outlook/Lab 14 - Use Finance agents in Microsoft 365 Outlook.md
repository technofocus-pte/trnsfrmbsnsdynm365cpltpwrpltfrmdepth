...
9.  In the **Deployment (Permissions)** step, review the app permissions
    and capabilities in connection with Copilot for Finance, select **Accept permissions**.
...
3.  In the search bar, type **Finance** and then select it from the **Apps** list.
...
7.  Open any email that you want to analyze. On the top menu for the
    selected email, select **All Apps**. Select the **Finance (Preview)** **in Microsoft 365 Copilot -Outlook** app.
...
9.  Click **Next** on the pop-up window of **Stay in the flow of your work**. Click **Next** until you reach the **Try now** button.
