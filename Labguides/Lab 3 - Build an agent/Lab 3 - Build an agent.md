...
1.  Sign in to **Microsoft Copilot Studio** with your **Office 365 admin
    tenant** credentials using +++https://go.microsoft.com/fwlink/?LinkId=2107702+++.
...
1.  Select **Topics** from the top bar.
     ...
     **Note**: Due to the screen resolution, you may not see the **Topics** tabs. Select +8 (Number may vary in your case)         and then Topics.

     ![](./media/image21.png)

2.  Select **+ Add a topic** > **Create from description with Copilot**.
...
2.  Enter +++**Thank you**+++ in the message box before 'What is your email address' and then select the {X} icon
...
2.  The **Conversation Start** message will appear, and your copilot will start a conversation. In response, enter a trigger     phrase for the topic that you've created and then select the **send** icon.
