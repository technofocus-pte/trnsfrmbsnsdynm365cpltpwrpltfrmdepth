...
5.  You can use the **Time period filter** and **Data filters** in your report.

     ![](./media/image51.png)

6.  Select the **Coaching opportunities page** from the left navigation
    pane. It displays conversational KPIs and summary charts for the selected time period.
...
8.  Select the **Conversation recordings** page from the left navigation
    pane. This page helps you listen to call recordings and understand the context of the conversation.
...
2.  Enter the following information:
     ...
     a. **EnvironmentPath**: URL to your Sales trial Dataverse environment. You must remove the https:// prefix from the environment path URL you enter. (To get URL, go to Power Platform admin center. Select **Manage** > **Environments** from the left navigation pane, click on **Sales trial**, and copy the **Environment URL**.
