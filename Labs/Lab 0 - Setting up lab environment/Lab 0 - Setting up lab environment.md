...
5.  If asked, provide **Contact Information** as below and then
    select **Submit**.
...
8.  From the left navigation pane,
    select **Manage** \> **Environments** and then you can see, **Dev
    One** is your Dataverse environment.

> ![Screenshot](./media/image8.png)

9.  You can now proceed to next exercise.

Exercise 2: Create a team in Microsoft Teams and enable Transcription in
Teams
...
2.  On **Get to know Teams**, select **Get Started**. Close the window
    which is asking for scanning QR code.

> ![Screenshot](./media/image9.png)
>
> ![Screenshot](./media/image10.png)

3.  On the left side of Teams, click **Teams**, click **+** to  **Join
    or create a team**.
...
5.  Enter the Team name as [**Test Team**](urn:gd:lg:a:send-vm-keys).
    In **Name the first channel** field
    enter [**TestChannel**](urn:gd:lg:a:send-vm-keys) and click
    on **Private**.
...
11. Select **Confirm** to make changes.

> ![Screenshot](./media/image22.png)

12. From left navigation pane, under **Voice**, select **Voicemail
    policies**. Select **Global (Org-wide default) policy**.

> ![Screenshot](./media/image25.png)

13. Toggle **Mask profanity in voicemail transcription** to **On** and
    then select **Save**.

> ![Screenshot](./media/image26.png)

14. Select **Confirm** to make changes.
...
5.  If pop up screen appears, then click on Launch Trail.
...
7.  Go to **Power Platform admin center** by navigating
    ...
    on **Manage** \> **Environments** and then you can see, **Customer
...
2.  Under **Apps**, select **Copilot Service Admin
    Center** (Formally, **Customer Service Admin Center**).
...
4.  IIn the **Productivity** pane, select **Manage** for **Copilot for
    questions and emails**.

> ![Screenshot](./media/image38.png)

5.  First check the checkbox under **Knowledge sources** for **Include a
    knowledge base or another typer of knowledge source** then check the
    checkbox for **Ask a question**, **Suggest a response** and **Help
    pane – write an email**. Scroll down, check the checkbox for **Let
    representative translate responses** under **Translation**..
...
Exercise 4: Assign Field Service trial license and install the Field
...
2.  If you are navigated to the **Dynamics 365 free trials** page,
    select **Dynamics 365 Field Service** and click **Try for
    free** else go to the next step.
...
5.  If pop-up appears which says **Launch trial** then click **Launch
...
1.  Navigate to [**admin.microsoft.com**](urn:gd:lg:a:send-vm-keys) and
    select **Show all**, then under **Settings**, click on **Integrated
    apps**. Scroll down, click on **Get apps** and search for **field
    service**.
...
2.  In the search box, enter **Field service** and then click on **Get
    it now** under **Dynamics 365 Field Service for Outlook**, and then
    again click on **Get it now** on **Confirm your
    information** pop-up.
...
It can take up to 72 hours for the app to appear in Outlook.

Exercise 5: Get Sales Copilot trial license and install Sales Copilot
add-in for Outlook
...
Exercise 6: Sign up for the trial and give consent to use Copilot in
...
5.  Select **United State**s for the **Country/region** field, enter
...
trail button. ![Screenshot](./media/image90.png)
...
8.  Select **Start trial** from the top right corner. If you get an
    error message as ‘**Couldn’t create environment**’ then follow the
    steps (a to f) given below and then continue with Styep 9.

> ![Screenshot](./media/image93.png)
>
> a\. Access your **Customer Insights - Data** environment using the
> given
> link [**https://home.ci.ai.dynamics.com/**](urn:gd:lg:a:send-vm-keys).
> Select **Sign up for trial**.
>
> ![Screenshot](./media/image94.png)
>
> b. **Sign up** using given **Office 365 tenant** credentials and
> select **Next**.
>
...
>
> d\. Enter **Country/region** as **United States**, your **job
> title** and **phone number**. Then select **Get Started**.
>
...
>
> f\. You will be on **Home** page of **Customer Insights –
> Data** portal. Now, select **Start trial**.
>
> ![Screenshot](./media/image99.png)

9.  You can see that **Marketing Trial** environment is getting created
    for you and now you can directly go to the step no 13. In case if
    environment is not created and asking for **Basic information** then
    enter [**Marketing Trial**](urn:gd:lg:a:send-vm-keys) in
    the **Name** field, select **United States** for
    the **Region** field, and then select **Next**.
...
3.  **Enable** the **Enable Copilot features powered by Azure
    OpenAI** and then select **Save**. Ignore if the switch is enabled
    alredy.
